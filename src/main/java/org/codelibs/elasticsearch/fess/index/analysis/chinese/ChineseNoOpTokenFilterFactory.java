...
public class ChineseNoOpTokenFilterFactory extends SelectableTokenFilterFactory {

    private static final String[] FACTORIES = { //
            "org.elasticsearch.plugin.analysis.smartcn.SmartChineseNoOpTokenFilterFactory" };

    public ChineseNoOpTokenFilterFactory(final IndexSettings indexSettings, final Environment env, final String name,

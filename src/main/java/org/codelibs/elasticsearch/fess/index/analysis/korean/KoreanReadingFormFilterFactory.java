...
public class KoreanReadingFormFilterFactory extends SelectableTokenFilterFactory {
    ...
    private static final String[] FACTORIES = { //
            "org.elasticsearch.plugin.analysis.nori.NoriReadingFormFilterFactory" };

    public KoreanReadingFormFilterFactory(final IndexSettings indexSettings, final Environment env, final String name,

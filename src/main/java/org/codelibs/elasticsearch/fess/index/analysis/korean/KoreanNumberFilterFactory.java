...
public class KoreanNumberFilterFactory extends SelectableTokenFilterFactory {

    private static final String[] FACTORIES = { //
            "org.elasticsearch.plugin.analysis.nori.NoriNumberFilterFactory" };

    public KoreanNumberFilterFactory(final IndexSettings indexSettings, final Environment env, final String name, final Settings settings,

...
public class TraditionalChineseConvertCharFilterFactory extends SelectableCharFilterFactory {

    private static final String[] FACTORIES = { //
            "org.elasticsearch.index.analysis.STConvertCharFilterFactory" };

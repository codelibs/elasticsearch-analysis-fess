...
public class KoreanPartOfSpeechStopFilterFactory extends SelectableTokenFilterFactory {

    private static final String[] FACTORIES = { //
            "org.elasticsearch.plugin.analysis.nori.NoriPartOfSpeechStopFilterFactory" };

    public KoreanPartOfSpeechStopFilterFactory(final IndexSettings indexSettings, final Environment env, final String name,
